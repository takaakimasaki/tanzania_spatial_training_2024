...
admin1_sf_3857<-st_transform(admin1_sf, 3857) %>% 
  mutate(area_km=st_area(geometry)/1000000)
tm_shape(admin1_sf_3857) + tm_polygons("area_km",style="quantile")
...
admin1_arusha_sf_3857 <- admin1_sf %>% 
  filter(ADM1_EN=="Arusha") %>% 
  st_transform(3857) 

road_arusha_admin1 <- st_join(road, admin1_arusha_sf_3857) %>% 
